...
var PaginationService = /** @class */ (function () {
    ...
    PaginationService.prototype.getPage = function (page, getUrl) {
...
var StoryService = /** @class */ (function () {
    ...
    StoryService.prototype.getAllStoryCategories = function () {
        return this.http.get(globals__WEBPACK_IMPORTED_MODULE_3__["rootURL"] + "storycategory");
    };
    StoryService.prototype.getStoryCategoryByID = function (ID) {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.putUser = function (userID, formData) {
    ...
    UserService.prototype.getPageOfUsers = function (page, size) {
...
var PaginationComponent = /** @class */ (function () {
    function PaginationComponent(paginService) {
    ...
    PaginationComponent.prototype.setPage = function (page) {
        ...
        this.paginService.getPage(page, this.getUrl)
            ...
            _this.pager = res;
            _this.paginService.pagData = res;
            _this.paginService.invokePage.emit(_this.pager);
        });
    };
...
var CreateStoryComponent = /** @class */ (function () {
    ...
    CreateStoryComponent.prototype.ngOnInit = function () {
        ...
        this.storyService.getAllStoryCategories().subscribe(function (res) {
            res.forEach(function (element) {
                _this.allCategories.push(element.categoryName);
            });
        });
    };
    CreateStoryComponent.prototype.postStory = function () {
        var _this = this;
        var token = localStorage.getItem("jwt");
    ...
    CreateStoryComponent.prototype.addCategory = function (cat) {
        this.categories.push(cat);
    };
    CreateStoryComponent.prototype.isSelected = function (cat) {
        return this.categories.indexOf(cat) > -1;
    };
    CreateStoryComponent.prototype.removeCategory = function (category) {
...
var StoriesComponent = /** @class */ (function () {
    function StoriesComponent(pgService, storyService, userService) {
    ...
    StoriesComponent.prototype.search = function () {
...
var StoryViewComponent = /** @class */ (function () {
    function StoryViewComponent(route, userService, storyService) {
        this.route = route;
        this.userService = userService;
        this.storyService = storyService;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, http, _snackBar) {
        this.router = router;
        this.http = http;
        this._snackBar = _snackBar;
    }
    ...
    LoginComponent.prototype.loginUser = function () {
        ...
        this.http.post(globals__WEBPACK_IMPORTED_MODULE_6__["rootURL"] + "api/auth/login", loginData, {
            ...
            _this._snackBar.open("Login Successful...", null, {
                duration: 3000,
                panelClass: ['green-sb']
            });
            ...
            console.log(err);
            _this._snackBar.open("Unauthorized...", null, {
                duration: 3000,
                panelClass: ['red-sb']
            });
        });
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(service, _snackBar) {
    ...
    RegisterComponent.prototype.registerUser = function (registerForm) {
        var _this = this;
        this.service.postUser(registerForm.value).subscribe(function (res) {
            registerForm.reset();
            _this._snackBar.open("User Registered...", null, {
                duration: 3000,
                panelClass: ['green-sb']
            });
        }, function (err) {
            console.log(err);
            _this._snackBar.open("Register Error...", null, {
                duration: 3000,
                panelClass: ['red-sb']
            });
        });
...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(userService, pgService, _snackBar) {
        this.userService = userService;
        this.pgService = pgService;
        this._snackBar = _snackBar;
        this.users = [];
    ...
    UsersComponent.prototype.deleteUser = function (userID) {
        ...
        this.userService.deleteUser(userID)
            ...
            _this._snackBar.open("User Deleted...", null, {
                duration: 3000,
                panelClass: ['green-sb']
            });
            _this.pgService.getPage(_this.pgService.pagData.page, _this.url).subscribe(function (res) {
                _this.paginationData = res;
    ...
    UsersComponent.prototype.editUser = function (userID) {
        var _this = this;
        this.userService.getUserById(userID).toPromise().then(function (user) {
    ...
    UsersComponent.prototype.submitUser = function () {
        ...
        this.userService.putUser(this.userService.formData.userID, this.userService.formData)
            .subscribe(function (res) {
            _this._snackBar.open("User Edited...", null, {
                duration: 3000,
                panelClass: ['green-sb']
            });
            _this.editForm.reset();
            _this.pgService.getPage(_this.pgService.pagData.page, _this.url)
                .subscribe(function (res) {
                _this.paginationData = res;
                _this.users = res.items;
            });
            ...
            console.log(err);
            _this._snackBar.open("Edit Error...", null, {
                duration: 3000,
                panelClass: ['red-sb']
            });
        });
